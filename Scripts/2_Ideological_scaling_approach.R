...
#Creating Document-Feature Matrix and removing all words used less than 5 times
...
tmod_wf[c('features','beta')] %>%  as_tibble() -> df_wordfish_feature
...
wordshoalfit <- wordshoal::textmodel_wordshoal(
  ...
  authors = docvars(dfm_wordfish, "Party"))
